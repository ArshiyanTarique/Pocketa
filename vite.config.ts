...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        // A stable identity, so a Play listing and an installed shortcut keep
        // pointing at the same app even if `start_url` ever changes.
        id: '/',
        name: 'Pocketa',
        short_name: 'Pocketa',
        description: 'A calm, accurate command centre for your money.',
        theme_color: '#0F1114',
