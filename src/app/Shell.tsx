...
function Wordmark({ compact = false }: { compact?: boolean }) {
  return (
    <Link to="/" className="flex items-center gap-2.5" aria-label="Pocketa home">
      <span className="flex size-9 items-center justify-center rounded-[--radius] bg-accent-fill text-[--accent-ink]">
        {/* Two stacked rules and a total — the reckoning mark. */}
        <svg viewBox="0 0 24 24" className="size-4" fill="none" aria-hidden="true">
          <path d="M5 8h14M5 12h9" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" />
          <path d="M5 17h14" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
        </svg>
      </span>
